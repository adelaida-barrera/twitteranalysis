...
We can broadly identify what the 10 topics are, although the model does not perfectly classify the documents according to our posterior interpretation.  
...
model_top_terms %>% 
  ...
  labs(x = "\n Word probabilities per topic (betas)",
       y = "Term \n", 
       title = "Ten most common terms within each topic") +
  scale_y_reordered() +
