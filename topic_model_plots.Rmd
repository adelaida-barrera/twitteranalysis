...
ggsave(topics_in_time_ins, file = "figures/10_topics_in_time_inst.png", height = 7, width = 11)

```

# Gathering a subset of the tweets that mainly talk about reproductive health.
